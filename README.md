![Last Commit](https://img.shields.io/github/last-commit/VeriFlowQA/PulseQA)
![Pull Requests](https://img.shields.io/github/issues-pr-raw/VeriFlowQA/PulseQA)
...
PulseQA is a **Flutter QA Automation Framework** built with [**Dart**](https://dart.dev/) and powered by [**Maestro**](https://github.com/mobile-dev-inc/Maestro), designed to enable scalable and maintainable testing for **mobile apps** (Android & iOS). It’s ideal for **UI flows**, **smoke tests**, **functional validation**, and **end-to-end test coverage**.

## 📹 Demo

![Demo](./docs/videos/PulseQA-demo.gif)
...
1. 🔹 **[PostgreSQL / TimescaleDB](https://www.timescale.com/)**
...
const password = () =>
  getLocator(`#password`).or(getLocatorByPlaceholder('Password', { exact: true }));
